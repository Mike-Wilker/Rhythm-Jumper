#pragma once
#ifndef _MIDIOPTIONS_H_INCLUDED
#define _MIDIOPTIONS_H_INCLUDED
#include <iostream>
#include <map>
#include <string>
#include <vector>
#define MIDIOPTION_BOOLEAN_TYPE 'b'
#define MIDIOPTION_CHAR_TYPE 'c'
#define MIDIOPTION_DOUBLE_TYPE 'd'
#define MIDIOPTION_FLOAT_TYPE 'f'
#define MIDIOPTION_INT_TYPE 'i'
#define MIDIOPTION_STRING_TYPE 's'
#define MIDIOPTION_UNKNOWN_TYPE 'x'
